...
\subsection{\PRA}
In this section we will specify the rules and language of \PRA. First, we
...
would be known as \textbf{PA}; Peano Arithmetics.  Having written down the
...
sequence $(j_0,\ldots j_t)$ we can encode it with a unique code in the following
way:
