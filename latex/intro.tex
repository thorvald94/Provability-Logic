...
\begin{enumerate}
	\item[\textbf{Chapter 1:}] This chapter will list some prerequisite results and
		definitions about the modal logic \GL and the system primitive
		recursive arithmetic. 
	\item[\textbf{Chapter 2:}] In this chapter is a short introduction to recursion
...
is \parencite{Smor1985}, \cite{Boolos1993} and \cite{Soare1987}.
