...
some results about it. Most of these results might not be used going
forward.
...
\begin{proof}
	...
	v\forall v^*<v\neg\zeta v^*\]
	Thus for a \textbf{Hvad mener Smor med PR} relation $\zeta$ we have
	that $\forall v^*<v\neg \zeta v^*$ is also PR, and thus since \PRA\ has
	RE-induction we have the least number principle for $\zeta$.
\end{proof}
...
induction PR-formulae. The following prop will give an answer to this question:
