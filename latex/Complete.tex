...
\begin{thm}
	...
	\begin{enumerate}
		...
		\item $\alpha$ is true in all $\alpha$-sound Kripke models
...
We
will assume that $\mathcal{K}$ is $\alpha$-sound. This means that we have:
...
theorem for a given arithmetic theory. \textbf{Ref den russiske artikle}. This
...
From table \ref{Fig} we can conclude the following things:
\begin{enumerate}
	\item From line 3, we have that
		...
		by Solovay's first completeness theorem we get that:
	...
	\item We can form line 1 and 6 infer that a sentence of arithemtic is 
	\item Line 10 gives us
	\item From line 6 we see
\end{enumerate}
