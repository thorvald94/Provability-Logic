...
This section will be written in the language of graph theory, which is the
language usually used to state and prove König's lemma. The section could be
translated into the language of modal logical frames, but it is not done here.
